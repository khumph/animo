...
blood_results$means %>%
  ...
  htmlTable(
    ...
    cgroup = c("Median assessments (MAD)", "Percent mean difference from baseline (95% CI)",
               "Percent mean differences between groups (95% CI)"),
    n.cgroup = c(3, 1, 2),
